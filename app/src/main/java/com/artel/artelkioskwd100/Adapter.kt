...
import com.artel.artelkioskwd100.databinding.ItemAppBinding
    ...
    override fun onBindViewHolder(holder: AppItemViewHolder, position: Int) {
        ...
        holder.appBinding.root.setOnClickListener {
            context.startActivity(
                context.packageManager.getLaunchIntentForPackage(appList?.get(position)?.packageName?:"com.artel.artelkioskwd100")
            )
        }
    }
